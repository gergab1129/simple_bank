...
type Querier interface {
	AddBalance(ctx context.Context, arg AddBalanceParams) (Accounts, error)
	...
	GetAccount(ctx context.Context, accountID int64) (Accounts, error)
	GetAccountForUpdate(ctx context.Context, accountID int64) (Accounts, error)
